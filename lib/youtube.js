...
module.exports = async function youtubeAPI(channelID, key, amountVideos){
    try {
        ...
        // console.log(data[0].data.items[0])
        ...
        const channelData = { 
            channel: {
                ...
                views: parseInt(channelIDData.data.items[0].statistics.viewCount) || 0,
                subscriber: parseInt(channelIDData.data.items[0].statistics.subscriberCount) || 0,
                ...
                videoCount: parseInt(channelIDData.data.items[0].statistics.videoCount) || 0,
            },
            videos: {
                0: {
